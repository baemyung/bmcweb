    ...
    BMCWEB_ROUTE(app, "/redfish/v1/EventService/Subscriptions/")
        ...
        .methods(
            ...
            if (!json_util::readJsonPatch(
                    ...
                    heartbeatIntervalMinutes, "MetricReportDefinitions",
...
auto obj = subscriptionsMap.find(subValue->id);
    ...
    BMCWEB_LOG_ERROR("TEST: PATCH obj2, , sendHeartbeat={}, heartbeatIntervalMinutes={}",
                sub2->sendHeartbeat , sub2->heartbeatIntervalMinutes);
            }
        }
#endif
            //
      ...
      // DEBUG WRITE
                 ...
                 EventServiceManager::getInstance().subscriptionsMap)
        {
                ...
                BMCWEB_LOG_ERROR("  TEST: subscriptionsMap entry ID={}, sendHeartbeat={}, heartbeatIntervalMinutes={}",
                 ...
                 persistent_data::EventServiceStore::getInstance().subscriptionsConfigMap)
        {
                ...
                BMCWEB_LOG_ERROR("  TEST: subscriptionsConfigMap entry ID={}, sendHeartbeat={}, heartbeatIntervalMinutes={}",
                        entry->id, entry->sendHeartbeat, entry->heartbeatIntervalMinutes);
        }
