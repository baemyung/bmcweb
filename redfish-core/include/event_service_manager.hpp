  ...
  public:
    ...
    void initConfig()
    {
                                  ...
                                  .subscriptionsConfigMap)
        {
            ...
            BMCWEB_LOG_ERROR(
                "TEST: initConfig, sendHeartbeat={}, heartbeatIntervalMinutes={}",
                subValue->sendHeartbeat, subValue->heartbeatIntervalMinutes);
        ...
        addSubscriptionInternal(const std::shared_ptr<Subscription>& subValue)
    {
        ...
        BMCWEB_LOG_ERROR(
            "TEST**** addSubscriptionInternal  id={}, newSub-id={} added to subscriptionsConfigMap ",
            id, newSub->id);
        persistent_data::EventServiceStore::getInstance()
        ...
        BMCWEB_LOG_ERROR(
            "TEST**** addSubscriptionInternal BEFORE DONE id={}, newSub-id={}, subValue-id={} added to subscriptionsConfigMap ",
        ...
        BMCWEB_LOG_ERROR(
            "TEST**** addSubscriptionInternal DONE id={}, newSub-id={}, subValue-id={} added to subscriptionsConfigMap ",
            id, newSub->id, subValue->id);
    ...
    {
        BMCWEB_LOG_ERROR(
            "TEST: addPushSubscription subValue: sendHeartbeat={}, heartbeatIntervalMinutes={}",
            subValue->sendHeartbeat, subValue->heartbeatIntervalMinutes);
        ...
        BMCWEB_LOG_ERROR(
            "TEST: addPushSubscription subValue: RETURN-ID={} sendHeartbeat={}, heartbeatIntervalMinutes={}",
