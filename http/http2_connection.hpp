  ...
  public:
    ...
    int onRequestRecv(int32_t streamId)
    {
        ...
        thisReq.session = crow::authentication::authenticate(
            {}, thisRes, thisReq.method(), *(thisReq.reqPtr), nullptr);
                                ...
                                const uint8_t* data, size_t len)
    {
        ...
        if (!thisStream->second.reqReader)
        {
            thisStream->second.reqReader.emplace(
                thisStream->second.req.reqPtr->base(),
                thisStream->second.req.reqPtr->body());
        }
        boost::beast::error_code ec;
                         ...
                         std::span<const uint8_t> value)
    {
        ...
        {
            thisReq.reqPtr->set(nameSv, valueSv);
        }
        return 0;
    }
