  ...
  private:
                          ...
                          std::size_t bytesTransferred)
    {
                                                     ...
                                                     parser->get().target()))
        {
            ...
            {
                BMCWEB_LOG_ERROR(
                    "TEST: afterReadHeaders POST UPDATE DUPPPPPP, countCodeUpdateInflightRequests()={}, fwUpdate={}",
                    countCodeUpdateInflightRequests(),
                    redfish::sw_util::fwUpdateInProgress());
            ...
            BMCWEB_LOG_ERROR(
                "TEST: afterReadHeaders POST UPDATE ADDED, countCodeUpdateInflightRequests()={}",
                countCodeUpdateInflightRequests());
        }
